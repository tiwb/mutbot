...
from mutbot.builtins.setup_toolkit import _write_config, MUTBOT_CONFIG_PATH
...
class TestWriteConfig:
    ...
    def test_write_creates_new_config(self, tmp_path, monkeypatch):
        monkeypatch.setattr("mutbot.builtins.setup_toolkit.MUTBOT_USER_DIR", tmp_path)
        monkeypatch.setattr("mutbot.builtins.setup_toolkit.MUTBOT_CONFIG_PATH", tmp_path / "config.json")
